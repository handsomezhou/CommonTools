...
import com.android.commontools.constant.TimePatternConstant;
...
public class TimeUtil {
     ...
     * @return
     */
    public static int getMilliSecondOfDay(long timeMs){
        Calendar calendar = Calendar.getInstance();
        ...
        long milliSecondOfDay=TimeUtil.hour2ms(hour_of_day)+TimeUtil.min2ms(minute)+TimeUtil.sec2ms(second)+milliSecond;

        return (int)milliSecondOfDay;
    }
