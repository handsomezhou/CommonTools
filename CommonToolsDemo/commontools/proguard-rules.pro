...
#############################################
# https://www.jianshu.com/p/f9438603e096
#
# 对于一些基本指令的添加
#
#############################################
...
#引入依赖包rt.jar（jdk路径）
-libraryjars 'D:\soft\Android\Android Studio\jre\jre\lib\rt.jar'
#引入依赖包android.jar(android SDK路径)
#-libraryjars 'E:\sdk\platforms\android-25\android.jar'
#如果用到其他包，需要引入
...
-keep public class com.android.commontools.** {*;}